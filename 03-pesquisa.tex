...
Os conceitos da melhoria contínua e retrospectiva já são a muito tempo conhecidos pela comunidade ágil. Mesmo assim, é necessário saber como a melhoria contínua é aplicada atualmente e encontrar quais são as dificuldades que os times ágeis enfrentam ao realizar estas reuniões, principalmente a retrospectiva. Com base nesta informação, pode se reduzir o viés com relação a quais problemas podem ser resolvidos através de alguma aplicação ou se um sistema sequer deveria ser construído.

Estes dados podem ser obtidos a partir a partir de uma revisão sistemática da literatura sobre retrospectivas e quais são os problemas em seu desenvolvimento. No entanto, a maior parte do material que existe hoje foca na aplicação da reunião e nos passos durante a retrospectiva.
